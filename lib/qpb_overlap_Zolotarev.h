...
void qpb_overlap_Zolotarev_init(void *, qpb_clover_term, int, qpb_double, qpb_double, qpb_double, qpb_double, qpb_double, int, qpb_double, int, qpb_double, qpb_double, qpb_double);
